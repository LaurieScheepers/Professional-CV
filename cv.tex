...
\addtolength{\voffset}{-0.4cm} % A bit of extra negative margin at top
	...
	\footnotesize{In general I believe that a programming language is just a language to learn, get used to the syntax and gain experience in - all languages differ in their feature set and also their purpose, one is not more difficult than the other, except for esoteric things like BrainFuck (which is made difficult on purpose as an exercise to the implementer and reader)} \\
